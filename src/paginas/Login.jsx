...
const Login = () => {
    ...
    // It uses the useNavigate hook from React Router for navigation. It also uses the useContext hook to access the setAuth and setEstado functions from the AuthContext. 
    // Additionally, it initializes a state variable mensaje using the useState hook to manage messages.
    const navigate = useNavigate()
    const {setAuth,setEstado} = useContext(AuthContext)
    const [mensaje, setMensaje] = useState({})

    // Form State Initialization and Change Handling
    // The component initializes a state variable form to manage the form inputs (email and password). 
    // The handleChange function is used to update the form state when the user types into the input fields.
